...
def test_null_model_defaults_and_poisson_boundary():
    ...
    assert utils.NULL_MODEL_P_THRESHOLD_DEFAULT == 1e-6
    # At 0.1% total error and 1,000x depth, the stricter null model removes
    # counts through six. The independent frequency floor can require more.
    assert records[-1] == (1_000, 6)
